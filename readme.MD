...
**why kubernetes? what are the befinifits we will get out of it? what issues it addressed interms of microservices architecture deployments using docker swarm?**
...
***Before understanding what Kubernetes is, it's important to first recognize the drawbacks of using Docker standalone or Docker Swarm***
